// LEGACY types from the previous AgroVibes build. Kept ONLY so the
// explicit state migration (migration.mo) can consume and drop the old
// stable variables during the upgrade to CropVibe. Do not use elsewhere.
module {
  // ── Enums ──────────────────────────────────────────────────────────────────
